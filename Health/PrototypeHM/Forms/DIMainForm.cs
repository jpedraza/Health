...
namespace PrototypeHM.Forms
{
    public partial class DIMainForm : DIForm
    {
        ...
        private void ÒÔËÒËÍËToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void Ô‡‡ÏÂÚ˚«‰ÓÓ‚¸ˇToolStripMenuItem_Click(object sender, EventArgs e)
        {
           
        }

        private void ÔÓÒÏÓÚToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ÚÂÒÚ˚”‰‡ÎËÚ¸ToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void ÒÓÁ‰‡Ú¸ÃÂÚ‡‰‡ÌÌÓÂToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ‰Ó·‡‚ËÚ¸ƒÓÍÚÓ‡ToolStripMenuItem_Click(object sender, EventArgs e)
        {
