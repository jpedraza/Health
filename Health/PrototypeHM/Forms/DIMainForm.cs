...
namespace PrototypeHM.Forms
{
    public partial class DIMainForm : DIForm
    {
        ...
        private void ïàğàìåòğûÇäîğîâüÿToolStripMenuItem_Click(object sender, EventArgs e)
        {
           
        }

        //private void ïğîñìîòğToolStripMenuItem_Click(object sender, EventArgs e)
        //{
        ...
        private void ñîçäàòüÍîâûéÒèïÌåòàäàííûõToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void òèïûÌåòàäàííûõToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ïàğàìåòğûÇäîğîâüÿToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void ïàğàìåòğûÇäîğîâüÿÈÄèàãíîçûÏàöèåíòîâToolStripMenuItem_Click(object sender, EventArgs e)
        {
