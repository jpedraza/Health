...
insert into Users (FirstName, LastName, ThirdName, Login, Password, RoleId, Birthday, Token)
	values('Швецова', 'Мария', 'Сергеевна', 'логин', 'пароль', 1, '1991-14-12', 'token_value')
...
insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 3, 'Анастасия Сергеевна', 1, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 2, 'Евгения Павловна', 2, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 1, 'Лидия Петровна', 3, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 1, 'Алла Васильевна', 4, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 4, 'Юлия Владимировна', 5, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 3, 'Александра Дмитриевна', 6, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 2, 'Светлана Тимофеевна', 7, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 1, 'Анна Игоревна', 8, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 1, 'Татьяна Петровна', 9, 34435, 32333, '---', '2001-21-09')

insert Patients(Card, FunctionalClassesId, Mother, PatientId, Phone1, Phone2, Policy, StartDateOfObservation)
	values('----', 1, 'Марья Ивановна', 10, 34435, 32333, '---', '2001-21-09')
...
('1992-25-07', '---', 'Сидоров', 'Андрей', 'Тихвинович',
 'log', 'pass', '', 212, '---', 1, 1232, 'token_value', '1998-07-12')

insert Candidates(Birthday, Card, FirstName, LastName, ThirdName, Login, Password, Mother, Phone1,
Policy, RoleId, Phone2, Token, StartDateOfObservation) values
('1992-25-07', '---', 'Сосницкий', 'Иван', 'Павлович',
 'log', 'pass', '', 212, '---', 1, 1232, 'token_value', '1998-16-12')

/*Связываем пациентов с диагнозами*/
